...
{
    public partial class frmV2Raporu : DevExpress.XtraEditors.XtraForm
    {
        public frmV2Raporu()
        {
            InitializeComponent();
        ...
        {
            SqlDataAdapter adp = new SqlDataAdapter(string.Format("SP_V2_RAPOR"), Baglanti2);
        ...
        void yazdir()
        {
            ...
            {
                string kontrolcu = gridView1.GetRowCellValue(i, gridView1.Columns["OZELALANTANIM_22"]).ToString();
        ...
        private void btnToplamYazdir_Click(object sender, EventArgs e)
        {
